 ...
 * @author samia
 */
public class AddWorldRecord extends javax.swing.JFrame {
    GetSetData getElements = new GetSetData();

    /**
     * Creates new form AddWorldRecord
     */
    public AddWorldRecord() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Añadir Record Mundial");
        ...
        jButton2.setActionCommand("Ver Tabla");
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        // TODO add your handling code here:
        String RecordDescription = DescriptionTextField.getText();
        int IDCountry = Integer.parseInt(IDCountryTextField.getText());
        int IDPerson = Integer.parseInt(IDPersonTextField.getText());
        ...
        getElements.insertWorldRecord(RecordDescription, IDCompetition, IDCountry, IDParalympic, IDPerson);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddWorldRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddWorldRecord().setVisible(true);
            }
        });
    }
