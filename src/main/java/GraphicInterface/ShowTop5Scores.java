 ...
 * @author samia
 */
public class ShowTop5Scores extends javax.swing.JFrame {
    GetSetData Elements = new GetSetData();

    /**
     * Creates new form ShowTop5Scores
     */
    public ShowTop5Scores() {
        initComponents();
    ...
    private void initComponents() {
        ...
        label1.setText("Top 5 Mejores Puntajes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowTop5Scores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowTop5Scores().setVisible(true);
            }
        });
    }
