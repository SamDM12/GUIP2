 ...
 * @author samia
 */
public class ShowWorldRecords extends javax.swing.JFrame {
    GetSetData Elements = new GetSetData();

    /**
     * Creates new form ShowWorldRecords
     */
    public ShowWorldRecords() {
        initComponents();
    ...
    private void loadDataFromDatabase() {
        ...
        try {
            rs = Elements.getWorldRecords(rs);  
    ...
    private void initComponents() {
        ...
        label1.setText("Records Mundiales");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowWorldRecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowWorldRecords().setVisible(true);
            }
        });
    }
