 ...
 * @author samia
 */
public class AddParalympicXCompetition extends javax.swing.JFrame {
    
    GetSetData getElements = new GetSetData();

    /**
     * Creates new form AddParalympicXCompetition
     */
    public AddParalympicXCompetition() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Registrar Competición en Paraolímpicos");
        ...
        label2.setText("Identificación Competencia");
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        getElements.insertParalympicXCompetition(IDParalympic, IDCompetition);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddParalympicXCompetition.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddParalympicXCompetition().setVisible(true);
            }
        });
    }
