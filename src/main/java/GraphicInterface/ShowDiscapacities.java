 ...
 * @author samia
 */
public class ShowDiscapacities extends javax.swing.JFrame {
    GetSetData Elements = new GetSetData();

    /**
     * Creates new form ShowDiscapacities
     */
    public ShowDiscapacities() {
        initComponents();
    ...
    private void loadDataFromDatabase() {
        ...
        try {
            rs = Elements.getDisabilities(rs);  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowDiscapacities.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowDiscapacities().setVisible(true);
            }
        });
    }
