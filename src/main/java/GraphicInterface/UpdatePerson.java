...
public class UpdatePerson extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        IDPersonTextField1 = new java.awt.TextField();
        ...
        label1.setText("Actualizar Persona");
        ...
        label14.setText("ID Persona");

        IDPersonTextField1.setName("IDPersonTextField"); // NOI18N
        IDPersonTextField1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                IDPersonTextField1ActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addComponent(IDPersonTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    .addComponent(jButton2)
                                                    .addComponent(IDPersonTextField1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(IDGenderTextField, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddButtonActionPerformed
        ...
        int IDPerson = Integer.parseInt(IDPersonTextField1.getText());
        ...
        Integer IDGenderName;
        if(IDGenderTextField.getText().isEmpty()){
            IDGenderName = null;
        }else{
            IDGenderName = Integer.parseInt(IDGenderTextField.getText());
        }
        
        Integer IDIdentificationName;
        if(IDIdentificationTypeTextField.getText().isEmpty()){
            IDIdentificationName = null;
        }else{
            IDIdentificationName = Integer.parseInt(IDIdentificationTypeTextField.getText());
        }
        
        if(IDPersonTextField.getText().isEmpty()){
            if (YearTextField.getText().isEmpty()){
               getElements.updatePerson(IDPerson, null, FirstName, SecondName, FirstLastName, SecondLastName, null, IDCountry, IDGenderName, IDIdentificationName); 
            }else {
                int Year = Integer.parseInt(YearTextField.getText());
                int Month = MonthComboBox.getSelectedIndex() + 1;
                int Day = Integer.parseInt((String)DayComboBox.getSelectedItem());
                LocalDate BirthDate = LocalDate.of(Year, Month, Day);
                getElements.updatePerson(IDPerson, null, FirstName, SecondName, FirstLastName, SecondLastName, BirthDate, IDCountry, IDGenderName, IDIdentificationName); 
            }
        }else {
            if (YearTextField.getText().isEmpty()){
                int IdentificationNumber = Integer.parseInt(IDPersonTextField.getText());
                getElements.updatePerson(IDPerson, IdentificationNumber, FirstName, SecondName, FirstLastName, SecondLastName, null, IDCountry, IDGenderName, IDIdentificationName);
            }else {
                int Year = Integer.parseInt(YearTextField.getText());
                int Month = MonthComboBox.getSelectedIndex() + 1;
                int Day = Integer.parseInt((String)DayComboBox.getSelectedItem());
                LocalDate BirthDate = LocalDate.of(Year, Month, Day);
                int IdentificationNumber = Integer.parseInt(IDPersonTextField.getText());
                getElements.updatePerson(IDPerson, IdentificationNumber, FirstName, SecondName, FirstLastName, SecondLastName, BirthDate, IDCountry, IDGenderName, IDIdentificationName); 
            }
        }
    ...
    private void IDPersonTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IDPersonTextField1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_IDPersonTextField1ActionPerformed
    ...
    private java.awt.TextField IDPersonTextField1;
