 ...
 * @author chedr
 */
public class ShowSTRangeAge extends javax.swing.JFrame {
     ...
     * @param year
     */
    public ShowSTRangeAge(int year) {
        this.year = year;
        initComponents();
    ...
    ArrayList<CompetitionType> competitions = getSetElements.getRangeAge(low, high, this.year);
...
private static DefaultPieDataset createDatasetCompetition(ArrayList<CompetitionType> competitions) {
    ...
    for (CompetitionType competition : competitions) {
        dataset.setValue(competition.getDescription() + ": " + competition.getQuantity(), competition.getQuantity());
    }
