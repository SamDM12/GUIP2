 ...
 * @author samia
 */
public class ShowPhoneTypes extends javax.swing.JFrame {
    GetSetData Elements = new GetSetData();

    /**
     * Creates new form ShowPhoneTypes
     */
    public ShowPhoneTypes() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowPhoneTypes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowPhoneTypes().setVisible(true);
            }
        });
    }
